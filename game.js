const gameData = {
    ...
    explanations: {
        "ברזל (Fe)": {
            ...
            "התחממות": "התחממות גורמת למולקולות הברזל לנוע מהר יותר, המתכת מתרחבת והופכת רכה יותר. בטמפרטורות גבוהות הברזל קל יותר לעיבוד וכיפוף.",
        ...
        "חמצן (O₂)": {
            ...
            "התחממות": "התחממות גורמת לגז החמצן להתרחב עוד יותר. המולקולות נעות במהירות גבוהה ותופסות הרבה יותר מקום.",
        ...
        "מים (H₂O)": {
            ...
            "התחממות": "התחממות מעלה את טמפרטורת המים. המולקולות נעות מהר יותר והמים מתרחבים מעט, אך נשארים נוזליים.",
        ...
        "פחמן (C)": {
            ...
            "התחממות": "התחממות גורמת לפחמן להתרחב ולשנות את המבנה שלו. יכולים להיווצר צורות שונות של פחמן.",
        ...
        "זהב (Au)": {
            ...
            "התחממות": "התחממות גורמת לזהב להתרחב ולהפוך רך יותר. זו הסיבה שצורפים מחממים זהב כדי לעבד אותו.",
        ...
        "כסף (Ag)": {
            ...
            "התחממות": "התחממות גורמת לכסף להתרחב. המולקולות נעות מהר יותר והמתכת תופסת יותר מקום.",
        ...
        "נחושת (Cu)": {
            ...
            "התחממות": "התחממות גורמת לנחושת להתרחב. המתכת הופכת רכה יותר וקלה יותר לעיבוד.",
        ...
        "אלומיניום (Al)": {
            ...
            "התחממות": "התחממות גורמת לאלומיניום להתרחב. המתכת הופכת רכה יותר.",
        ...
        "גופרית (S)": {
            ...
            "התחממות": "התחממות גורמת לגופרית להתרכך. היא הופכת גמישה יותר לפני שהיא נמסת.",
        ...
        "מגנזיום (Mg)": {
            ...
            "התחממות": "התחממות גורמת למגנזיום להתרחב. המתכת הופכת רכה יותר.",
